...
public class MeanReciprocalRankTest extends IrAbstractTest {
    ...
    public static void setUpBeforeClass() throws Exception {
        ...
        for (List<String> predictions : predictionsLists) {
            for (String precdiction : predictions) {
                System.out.println("prediction:" + precdiction);
            }
        }
        ...
        for (String gold : allGolds.keySet()) {
